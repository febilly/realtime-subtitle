...
function createHarness(options = {}) {
    ...
    const actions = {
        ...
        applySleepOnSilenceConfig: action('sleepConfig'),
        applyOscSensitiveFilterConfig: action('oscFilterConfig'),
        applyOscSensitiveFilterNoticeConfig: action('oscFilterNoticeConfig'),
        applyInterruptRepairConfig: action('interruptConfig'),
